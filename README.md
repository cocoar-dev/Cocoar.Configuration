...
| Provider | Package | Change Signal | Notes |
|----------|---------|---------------|-------|
| **Static** | Core | ❌ Snapshot only | Seed defaults / compose dependent values |
...
- [Static Provider](src/Cocoar.Configuration/Providers/StaticJsonProvider/README.md) - In-memory seeding & dependent composition
