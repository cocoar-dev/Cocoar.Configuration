...
public sealed class FileSourceRuleOptions
{
    ...
    public FileSourceRuleOptions(string directory, string filename, string? configurationPath = null, string? targetPath = null, TimeSpan? debounceTime = null)
    {
    ...
    public static FileSourceRuleOptions FromFilePath(string filePath, string? configurationPath = null, string? targetPath = null, TimeSpan? debounceTime = null)
    {
        ...
        return new FileSourceRuleOptions(directory, filename, configurationPath, targetPath, debounceTime);
    }
    ...
    public FileSourceProviderQueryOptions ToQueryOptions() => new(Filename, ConfigurationPath, TargetPath);
}
