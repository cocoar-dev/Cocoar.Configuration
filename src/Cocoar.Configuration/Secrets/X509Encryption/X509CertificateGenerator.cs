...
public static class X509CertificateGenerator
{
    ...
    /// <summary>
    /// Restricts file permissions to owner-only on non-Windows platforms.
    /// On Unix/macOS sets mode 600 (owner read+write only).
    /// On Windows this is a no-op — file ACLs should be configured separately.
    /// </summary>
